...
export default function Index() {
  ...
  return (
    <div className="flex flex-col h-full">
      <header className="border-b border-border h-14 flex items-center px-4 gap-4 bg-background sticky top-0 z-10 ml-64">
      ...
      <div className="border-b border-border bg-background/95 sticky top-14 z-[5] ml-64">
      ...
      <main className="flex-1 p-4 bg-background ml-64">
